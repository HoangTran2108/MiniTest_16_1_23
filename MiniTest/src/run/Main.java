...
public class Main {
    public static void main(String[] args) {
        ManagerMaterial materialManager = new ManagerMaterial();
        ...
        do {
            ...
            switch (checkInput) {
                case 1 -> materialManager.display();
                case 2 -> {
                ...
                case 7 -> materialManager.totalPriceMeat();
                case 8 -> materialManager.totalPriceCrispyFlour();
